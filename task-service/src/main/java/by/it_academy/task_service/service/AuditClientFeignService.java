...
@Service
public class AuditClientFeignService implements IAuditClientService {

    private final IAuditClient auditClient;

    private final JwtTokenHandler tokenHandler;

    public AuditClientFeignService(IAuditClient auditClient, JwtTokenHandler jwtTokenHandler) {
