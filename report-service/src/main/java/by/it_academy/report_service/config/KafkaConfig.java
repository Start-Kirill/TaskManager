...
public class KafkaConfig {
    ...
    @Bean
    public Map<String, Object> auditProducerConfig() {
    ...
    @Bean
    public ProducerFactory<String, AuditCreateDto> producerAuditFactory() {
        return new DefaultKafkaProducerFactory<>(auditProducerConfig());
    }
